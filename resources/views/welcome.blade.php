    ...
    <div class="row">
        <div class="col-lg-3 col-sm-6">
            <div class="card gradient-1">
                <div class="card-body">
                    <h3 class="card-title text-white">Total traversants</h3>
                    <div class="d-inline-block">
                        <h2 class="text-white">{{ $alltrav }}</h2>
                        <p class="text-white mb-0">avec carte identifiée </p>
                    </div>
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card gradient-2">
                <div class="card-body">
                    <h3 class="card-title text-white">Total Entrées</h3>
                    <div class="d-inline-block">
                    <h2 class="text-white">{{ $allEntry }}</h2>
                        <p class="text-white mb-0">par TAG-ENTREE</p>
                    </div>
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card gradient-3">
                <div class="card-body">
                    <h3 class="card-title text-white">Total Sorties</h3>
                    <div class="d-inline-block">
                        <h2 class="text-white">{{ $allSortie }}</h2>
                        <p class="text-white mb-0">par TAG-SORTIE</p>
                    </div>
                    <span class="float-right display-5 opacity-5"><i class="fa fa-users"></i></span>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card gradient-4">
                <div class="card-body">
                    <h3 class="card-title text-white">Autorisations</h3>
                    <div class="d-inline-block">
                    <h2 class="text-white">{{ $allNonAccess }}:Non</h2>
                        <p class="text-white mb-0">des mouvements</p>
                    </div>
    ...
    <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-widget">
                    <div class="card-body">
                        <h5 class="text-muted">Entrées</h5>
                        <h2 class="mt-4">{{ $allEntry }}</h2>
                        <span>Non Autoriser</span>
                        <div class="mt-4">
                            <h4>{{ $allNonAccess }}</h4>
                            <h6> <span class="pull-right">{{ $allNonAccess }}%</span></h6>
                            <div class="progress mb-3" style="height: 7px">
                            <div class="progress-bar bg-primary" style="width: {{ $allNonAccess }}%;" role="progressbar"><span class="sr-only">{{ $allNonAccess }}% cartes</span>
                                </div>
                            </div>
                        </div>
